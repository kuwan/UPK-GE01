...
extension YCTitleView {
    func setTitleWithProgress(_ progress : CGFloat, sourceIndex : Int, targetIndex : Int) {
        ...
        if(sourceIndex != targetIndex){
            ...
            // 3.2.变化sourceLabel
            sourceLabel.textColor = UIColor(red: (selectedColorRGB.0 - colorDelta.0 * progress)/255.0, green: (selectedColorRGB.1 - colorDelta.1 * progress)/255.0, blue: (selectedColorRGB.2 - colorDelta.2 * progress)/255.0, alpha: 1)
            
            
            //(r: selectedColorRGB.0 - colorDelta.0 * progress, g: selectedColorRGB.1 - colorDelta.1 * progress, b: selectedColorRGB.2 - colorDelta.2 * progress)
            
            // 3.2.变化targetLabel
            targetLabel.textColor = UIColor(red: (normalColorRGB.0 + colorDelta.0 * progress)/255.0, green: (normalColorRGB.1 + colorDelta.1 * progress)/255.0, blue: (normalColorRGB.2 + colorDelta.2 * progress)/255.0, alpha: 1)
            //(r: normalColorRGB.0 + colorDelta.0 * progress, g: normalColorRGB.1 + colorDelta.1 * progress, b: normalColorRGB.2 + colorDelta.2 * progress)
